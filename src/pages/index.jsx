      ...
      <Layout>
        <div className="container">
          ...
          <div className="hero">
            ...
            <div className="parallax-iframe window" style={{ width: "60%", height: "334px" }}>
                <iframe title="parallax" src="/webVR/" style={{ width: "100%", height: "100%", border: "none", overflow: "hidden" }} />
            </div>
